...
for layer in base_model.layers[-10:]:  # Descongela las últimas 10 capas para ajuste fino
...
modelo_guardado = os.path.join(directorio_padre, 'ModelosGeneradosH5', '3. [ResNet50] + [(15-10)] + [Augmentation] + [neuronas descongeladas -10] + [ (+) neuronas]', 'TEST-01','entrenarPrecargado.h5')
