...
altura, longitud = 299, 299  # Resolución recomendada para InceptionV3
batch_size = 16
epocas_transfer = 10  # Épocas para Transfer Learning
epocas_finetuning = 5  # Épocas para Fine-Tuning
...
entrenamiento_datagen = ImageDataGenerator(
    ...
    vertical_flip=True,  # Sin inversión vertical para mantener consistencia de orientación
...
# Cargar modelo base preentrenado (InceptionV3)
base_model = InceptionV3(weights='imagenet', include_top=False, input_shape=(altura, longitud, 3))
...
x = base_model.output
x = GlobalAveragePooling2D()(x)  # Sustituye Flatten por GlobalAveragePooling2D para eficiencia
...
# Transfer Learning
print("Iniciando Transfer Learning con InceptionV3...")
history = model.fit(
...
for layer in base_model.layers[-10:]:  # Ajuste fino con 7 capas
...
# Fine-Tuning
print("Iniciando Fine-Tuning con InceptionV3...")
