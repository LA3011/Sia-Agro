        ...
        <div class="modal-dialog modal-lg" style="max-width: 900px;">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #0d6efd; color: white;">
              <h5 class="modal-title text-center w-100">Registro del Costo fijo </h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
              <form method="POST" action="procesar/procesar_costo_fijo.php" style="padding: 0 50px 0 50px;"
        ...
        if (input.value < 1) {
            input.value = "";
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="Observaciones" required placeholder="Eje: Factura"
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <h5 class="card-title" style="color:black; font-size:40px; margin-left:7%;"> Costos Fijos</h5>
...
$sql = "SELECT * FROM costo_fijo ORDER BY \"Id_fijo\"";
...
if ($result->rowCount() > 0) {
    ...
    while ($fila = $result->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group" role="group">
                              ...
                              type="button" data-bs-toggle="modal" data-bs-target='#basicModal-VER<?php echo $fila["Id_fijo"]; ?>'
                              title="Editar">
                            ...
                            <!-- Boton-modal [Editar] -->
                            <a style="color:none; margin:5px; width:32px; padding-left:2px; font-size:25px; background-color:none;"
                            type="button" data-bs-toggle="modal" data-bs-target='#basicModal-<?php echo $fila["Id_fijo"]; ?>'
                            title="Editar">
                          ...
                          <a type="button" data-bs-toggle="modal" data-bs-target="#smallModal-<?php echo $fila["Id_fijo"]; ?>"
                        ...
                        <!-- modal [eliminar] -->
                        <div class="modal fade" id="smallModal-<?php echo $fila["Id_fijo"]; ?>" tabindex="-1">
                          <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                href='deshabilitaciones/deshabilitar_costo_fijo.php?id=<?php echo $fila["Id_fijo"] ?>&session_acceso=<?php echo isset($_SESSION["Usuario"]) ? $_SESSION["Usuario"] : ""; ?>&session_id=<?php echo isset($_SESSION["Id_Usuario"]) ? $_SESSION["Id_Usuario"] : ""; ?>'
                                title="Eliminar">
                      ...
                      <!------- modal de ver -------->
                      <div class="modal fade" id="basicModal-VER<?php echo $fila["Id_fijo"]; ?>" tabindex="-1">
                        <div class="modal-dialog modal-lg" style="max-width: 900px;">
                          <div class="modal-content">
                            <div class="modal-header" style="background-color: #0d6efd; color: white;">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="actualizar/actualizar_costo_fijo.php"
                              onsubmit="return validarFormulario();">
                              <div>
                                <input style="pointer-events: none;" type="hidden" class="form-control" name="Id_fijo"
                                value='<?php echo $fila["Id_fijo"]; ?>'>
                              </div>
                              <div class="row mb-2">
                              ...
                              <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                  <input style="pointer-events: none;" type="number" class="form-control" name="Monto"  required placeholder="" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                  ...
                  <!------- modal de actualizar -------->
                  <div class="modal fade" id="basicModal-<?php echo $fila["Id_fijo"]; ?>" tabindex="-1">
                    <div class="modal-dialog modal-lg" style="max-width: 900px;">
                      <div class="modal-content">
                        <div class="modal-header" style="background-color: #0d6efd; color: white;">
                        ...
                        <div class="modal-body">
                          ...
                          onsubmit="return validarFormulario();">
                          <div>
                            <input type="hidden" class="form-control" name="Id_fijo"
                            value='<?php echo $fila["Id_fijo"]; ?>'>
                          </div>
                          <div class="row mb-2">
                            <label class="col-sm-3 col-form-label" style="color:#21618C;">Nombre</label>
