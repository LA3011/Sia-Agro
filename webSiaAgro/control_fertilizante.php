...
<head>
  ...
  <link rel="stylesheet"type="text/css" href="css_personalizado/estilo_control_fertilizante.css">
</head>
<body>
        ...
        <div class="modal-dialog modal-lg" style="max-width: 670px;">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #0d6efd; color: white;">
              <h5 class="modal-title " id="registrarActividadModalLabel" style="margin-left:35%;">Registro Información</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <!-- Formulario para registrar la actividad -->
              <form id="dateForm" method="POST" action="procesar/procesar_control_fertilizante.php" style="padding: 0 50px 0 50px;">
                <div class="row mb-3">
        ...
        ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input  oninput="validateAnimalNumber(this)" type="number" class="form-control" id="validationCustom01" required name="Dosis"  required placeholder="Ej: 100" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input  oninput="validateAnimalNumber(this)" type="number" class="form-control" id="validationCustom01" required name="Cantidad"  required placeholder="Ej: 100" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                  </div>
                </div>
    ...
    function validateAnimalNumber(input) {
        ...
        ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input min="2020-01-01" type="date" class="form-control" id="fecha_inicio" required name="Fecha_inicial">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="date" min="2020-01-01" class="form-control" id="fecha_final" required name="Fecha_final">
                  </div>
                </div>
        ...
        fechaSiembraInput.addEventListener("change", function () {
            ...
            if (fechaCosecha && fechaSiembra > fechaCosecha) {
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01" required name="Encargado"  required placeholder="Ej: Diego" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01"  required name="Maquinaria"  required placeholder="Ej: Cisternas" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01" required name="Nota"  required placeholder="Ej: Ninguna" >
                  </div>
                </div>
        ...
        <section class="section">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Control Fertilizantes</li>
            </ol>
          </nav>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <h5 class="card-title" style="color:black; font-size:40px;">Control de fertilizantes</h5>
                  </div>
...
$sql = "SELECT * FROM control_fertilizante ORDER BY \"Id_fertilizante\"";
    ...
    while ($fila = $result->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                          <tr>
                            ...
                            <td>
                              <?php echo date("d/m/Y", strtotime($fila['Fecha_inicial'])); ?>
                            </td>
                            <td>
                              <?php echo date("d/m/Y", strtotime($fila['Fecha_final'])); ?>
                            </td>
                            <td>
                            ...
                            <div class="modal fade" id="smallModal-<?php echo $fila["Id_fertilizante"]; ?>" tabindex="-1">
                              <div class="modal-dialog modal-sm">
                                ...
                                <div class="modal-footer">
                                  ...
                                  href='deshabilitaciones/deshabilitar_control_fertilizante.php?id=<?php echo $fila["Id_fertilizante"] ?>&session_acceso=<?php echo isset($_SESSION["Usuario"]) ? $_SESSION["Usuario"] : ""; ?>&session_id=<?php echo isset($_SESSION["Id_Usuario"]) ? $_SESSION["Id_Usuario"] : ""; ?>'
                                  title="Eliminar">
                        ...
                        <div class="modal fade" id="basicModal-VER<?php echo $fila["Id_fertilizante"]; ?>" tabindex="-1">
                          ...
                          <div class="modal-dialog modal-lg" style="max-width: 670px;">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-header" style="background-color: #0d6efd; color: white;">
                                <h5 class="modal-title" id="registrarActividadModalLabel" style="margin-left:35%;">Ver información
                                </h5>
                              ...
                              <div class="modal-body">
                                ...
                                <form method="POST" action="actualizar/actualizar_control_fertilizante.php">
                                  <div>
                                    <input style="pointer-events: none;" type="hidden" class="form-control" name="Id_fertilizante"
                                    value='<?php echo $fila["Id_fertilizante"]; ?>'>
                                  </div>
                                  <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" style="color:#21618C;">Parcela</label>
                                  <div class="col-sm-10">
                                ...
                                value='<?php echo $fila["Parcela"]; ?>'>
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Dosis (ml)</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Cantidad</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" style="color:#21618C;">Tipo de
                                  cultivo</label>
                                  <div class="col-sm-10">
                                ...
                                value='<?php echo $fila["Tipo_cultivo"]; ?>'>
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Prioridad</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Fecha inicial</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Fecha Final</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Encargado</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Maquinaría</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" style="color:#21618C;">Nota</label>
                                    <div class="col-sm-10">
            ...
            ?>
                                ...
                                <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" style="color:#21618C;">Fecha inicial</label>
                                  <div class="col-sm-10">
                                    <input id="fechainicio_act" min="2020-01-01" type="date" class="form-control" name="Fecha_inicial"
                                    value='<?php echo $fila["Fecha_inicial"]; ?>'>
                                  </div>
                                </div>
                                <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" style="color:#21618C;">Fecha Final</label>
                                  <div class="col-sm-10">
                                    <input id="fechafinal_act" min="2020-01-01" type="date" class="form-control" name="Fecha_final"
                                    value='<?php echo $fila["Fecha_final"]; ?>'>
                                  </div>
                                </div>
