...
try {
    ...
    $sql = "INSERT INTO control_fertilizante
            (\"Parcela\", \"Dosis\", \"Cantidad\", \"Tipo_cultivo\", \"Prioridad\", \"Fecha_inicial\", \"Fecha_final\", \"Encargado\", \"Maquinaria\", \"Nota\" ) 
            VALUES (:Parcela, :Dosis, :Cantidad, :Tipo_cultivo, :Prioridad, :Fecha_inicial, :Fecha_final, :Encargado, :Maquinaria, :Nota)
    ...
    if ($stmt->execute()) {
        ...
        $numero_registro = $stmt->fetch(PDO::FETCH_ASSOC)['Id_fertilizante'];
