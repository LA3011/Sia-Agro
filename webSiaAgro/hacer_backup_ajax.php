...
try {
    ...
    echo json_encode(['success' => true, 'message' => "Backup realizado exitosamente. Archivo: backups/backup_$fecha.sql"]);

} catch (Exception $e) {
    echo json_encode(['success' => false, 'message' => "Error al realizar el backup: " . $e->getMessage()]);
}
?>