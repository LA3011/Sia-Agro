...
<head>
  <meta charset="utf-8">
  <title>Listado de agroquimicos</title>
  <script type="text/javascript" src="js/jquery-3.7.1.min.js"></script> 
  <script type="text/javascript" src="js/sweetalert2.all.min.js"></script> 
  <link rel="stylesheet"type="text/css" href="css_personalizado/estilo_funguisida.css">
</head>
<body>
        ...
        <div class="modal-dialog modal-lg" style="max-width: 900px;">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="procesar/procesar_funguisida.php" style="padding: 0 50px 0 50px;">
                <div class="row mb-2">
                  <label for="inputText" class="col-sm-3 col-form-label">Nombre</label>
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01" required name="nombre_funguisida" required placeholder="Ej: plaguicidas" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')" >
                  </div>
                </div>

                <div class="row mb-2">
                  <label for="inputText" class="col-sm-3 col-form-label">tipo de Fitosanitario</label>
                  <div class="col-sm-9">
                    <select class="form-select" id="tipo_presentacion" name="tipo_funguisida" required>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-9">
                    <select class="form-select" id="tipo_presentacion" name="tipo_presentacion" required>
                      <option value="">Seleccione una opción</option>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01" required name="marca"  required placeholder="Ej:Herbicide" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')" >
                  </div>
                </div>

                <div class="row mb-2">
                  <label for="inputText" class="col-sm-3 col-form-label">Composición</label>
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input type="text" class="form-control" id="validationCustom01" required name="composicion"  required placeholder="Ej: Dinitroanilinas" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')" >
                  </div>
                </div>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input 2020-01-01 type="date" class="form-control" id="fecha_vencimiento" required name="Fecha_vencimiento">
                  </div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                  <label for="inputnumber" class="col-sm-3 col-form-label">Unidad de medida </label>
                  <div class="col-sm-9">
                    <!-- especifica el tamaño del campo -->
                    <input  type="text" class="form-control" id="validationCustom01" required name="unidad_medida"  required placeholder="Ej: ml"oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')">
                  </div>
                </div>
        ...
        <section class="section">
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Agroquímicos</li>
            </ol>
          </nav>
          <div class="container">
            <div class="row justify-content-center">
              ...
              <div class="col-lg-3">
                <div class="card" style="background-color:  #99ff99; color: white; height: 132px;border:1px solid black; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">
                  <div class="card-body">
...
$sql = "SELECT * FROM insumos_funguisidas WHERE estado = 'activo' ORDER BY \"Id_funguisida\" ASC";
    ...
    while ($fila = $result->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                              <tr>
                                ...
                                <td>
                                  <?php echo $fila['nombre_funguisida']; ?>
                                </td>
                                <td>
                                  <?php echo $fila['tipo_funguisida']; ?>
                                </td>
                                <td>
                                  <?php echo $fila['marca']; ?>
                                </td>
                                ...
                                <td>
                                  <?php echo date("d/m/Y", strtotime($fila['Fecha_adquisicion'])); ?>
                                </td>
                                <td>
                                  <?php echo date("d/m/Y", strtotime($fila['Fecha_vencimiento'])); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                  <div class="btn-group" role="group">
                                    ...
                                    <div class="btn-group" role="group">
                                      ...
                                      type="button" data-bs-toggle="modal" data-bs-target='#basicModal-VER<?php echo $fila["Id_funguisida"]; ?>'
                                      title="Editar">
                                    ...
                                    <!-- Boton-modal [Editar] -->
                                    <a style="color:none; margin:5px; width:32px; padding-left:2px; font-size:25px; background-color:none;"
                                    type="button" data-bs-toggle="modal" data-bs-target='#basicModal-<?php echo $fila["Id_funguisida"]; ?>'
                                    title="Editar">
                                  ...
                                  <a type="button" data-bs-toggle="modal" data-bs-target="#smallModal-<?php echo $fila["Id_funguisida"]; ?>"
                                ...
                                <!-- modal [eliminar] -->
                                <div class="modal fade" id="smallModal-<?php echo $fila["Id_funguisida"]; ?>" tabindex="-1">
                                  <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      href='deshabilitaciones/deshabilitar_funguisida.php?id=<?php echo $fila["Id_funguisida"] ?>&session_acceso=<?php echo isset($_SESSION["Usuario"]) ? $_SESSION["Usuario"] : ""; ?>&session_id=<?php echo isset($_SESSION["Id_Usuario"]) ? $_SESSION["Id_Usuario"] : ""; ?>'
                                      title="Eliminar">
                            ...
                            <!------- modal de ver -------->
                            <div class="modal fade" id="basicModal-VER<?php echo $fila["Id_funguisida"]; ?>" tabindex="-1">
                              ...
                              <div class="modal-dialog modal-lg" style="max-width: 900px;">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <form method="POST" action="actualizar/actualizar_funguisidas.php">
                                      <div>
                                        <input style="pointer-events: none;" type="hidden" class="form-control" name="Id_funguisida"
                                        value='<?php echo $fila["Id_funguisida"]; ?>'>
                                      </div>
                                      <div class="row mb-2">
                                        <label class="col-sm-3 col-form-label" style="color:#21618C;">Nombre del Producto
                                        </label>
                                        <div class="col-sm-9">
                                          <input style="pointer-events: none;" type="text" class="form-control" name="nombre_funguisida" required placeholder=" " oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')"
                                          value='<?php echo $fila["nombre_funguisida"]; ?>'>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row mb-2">
                                        ...
                                        Fitosanitario</label>
                                        <div class="col-sm-9">
                                          <select style="pointer-events: none;" class="form-select" id="tipo_funguisida" name="tipo_funguisida" required>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Insecticida' ? "selected='selected'" : "" ?>value="Insecticida">Insecticida</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Fungicida' ? "selected='selected'" : "" ?>value="Fungicida">Fungicida</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Herbicida' ? "selected='selected'" : "" ?>value="Herbicida">Herbicida</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Fertiriego' ? "selected='selected'" : "" ?>value="Fertiriego">Fertiriego</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Acaricida' ? "selected='selected'" : "" ?>value="Acaricida">Acaricida</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Nematicida' ? "selected='selected'" : "" ?>value="Nematicida">Nematicida</option>
                                            <option <?php echo $fila["nombre_funguisida"] === 'Otro' ? "selected='selected'" : "" ?>value="Carne">Otro</option>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row mb-2">
                                        ...
                                        presentación</label>
                                        <div class="col-sm-9">
                                          <select style="pointer-events: none;" class="form-select" id="tipo_presentacion" name="tipo_presentacion"
                                          required>
                                          <option <?php echo $fila["tipo_presentacion"] === 'Liquido' ? "selected='selected'" : "" ?>value="Liquido">Líquido</option>
                                          <option <?php echo $fila["tipo_presentacion"] === 'Granulado' ? "selected='selected'" : "" ?>value="Granulado">Granulado</option>
                                          <option <?php echo $fila["tipo_presentacion"] === 'Polvo' ? "selected='selected'" : "" ?>value="Polvo">Polvo</option>
                                          <option <?php echo $fila["tipo_presentacion"] === 'Tableta' ? "selected='selected'" : "" ?>value="Fertiriego">Tableta</option>
                                          <option <?php echo $fila["tipo_presentacion"] === 'Otro' ? "selected='selected'" : "" ?>value="Carne">Otro</option>
                                        </select>
                                   ...
                                   <div class="row mb-2">
                                    ...
                                    Adquisición</label>
                                    <div class="col-sm-9">
                                      <input min="2020-01-01" style="pointer-events: none;" type="date" class="form-control" name="Fecha_adquisicion"
                                  ...
                                  <div class="row mb-2">
                                    ...
                                    vencimiento</label>
                                    <div class="col-sm-9">
                                      <input min="2020-01-01" style="pointer-events: none;" type="date" class="form-control" name="Fecha_vencimiento"
                                  ...
                                  <div class="row mb-2">
                                    <label class="col-sm-3 col-form-label" style="color:#21618C;">composición </label>
                                    <div class="col-sm-9">
                                      <input style="pointer-events: none;" type="text" class="form-control" name="composicion"  required placeholder=" " oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')"  
                                      value='<?php echo $fila["composicion"]; ?>'>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row mb-2">
                                    ...
                                    (Bs)</label>
                                    <div class="col-sm-9">
                                      <input style="pointer-events: none;" type="number" class="form-control" name="precio_unitario"
                      ...
                      <!------- modal de actualizar -------->
                      <div class="modal fade" id="basicModal-<?php echo $fila["Id_funguisida"]; ?>" tabindex="-1">
                        ...
                        <div class="modal-dialog modal-lg" style="max-width: 900px;">
                          ...
                          <div class="modal-content">
                            <!-- Este div define el encabezado de la ventana modal y contiene el título "Editar Usuario" y un botón para cerrar la ventana -->
                            <div class="modal-header" style="background-color: #0d6efd; color: white;">
                              <h5 class="modal-title" id="registrarActividadModalLabel" style="margin-left: 38%;">Actualizar información
                              </h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal"
                              aria-label="Close"></button>
                            </div>
                            ...
                            <div class="modal-body">
                              ...
                              <form method="POST" action="actualizar/actualizar_funguisidas.php">
                                <div>
                                  <input type="hidden" class="form-control" name="Id_funguisida"
                                  value='<?php echo $fila["Id_funguisida"]; ?>'>
                                </div>
                                <div class="row mb-2">
                                  <label class="col-sm-3 col-form-label" style="color:#21618C;">Nombre del Producto
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nombre_funguisida" required placeholder=" " oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')"
                                    value='<?php echo $fila["nombre_funguisida"]; ?>'>
                                  </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                  ...
                                  Fitosanitario</label>
                                  <div class="col-sm-9">
                                    <select class="form-select" id="tipo_funguisida" name="tipo_funguisida" required>
                                      <option <?php echo $fila["nombre_funguisida"] === 'Insecticida' ? "selected='selected'" : "" ?>value="Insecticida">Insecticida</option>
                                      <option <?php echo $fila["nombre_funguisida"] === 'Fungicida' ? "selected='selected'" : "" ?>value="Fungicida">Fungicida</option>
                                      <option <?php echo $fila["nombre_funguisida"] === 'Herbicida' ? "selected='selected'" : "" ?>value="Herbicida">Herbicida</option>
                                      <option <?php echo $fila["nombre_funguisida"] === 'Fertiriego' ? "selected='selected'" : "" ?>value="Fertiriego">Fertiriego</option>
                                ...
                                <div class="row mb-2">
                                  ...
                                  presentación</label>
                                  <div class="col-sm-9">
                                    <select class="form-select" id="tipo_presentacion" name="tipo_presentacion"
                                    required>
                                    <option <?php echo $fila["tipo_presentacion"] === 'Liquido' ? "selected='selected'" : "" ?>value="Liquido">Líquido</option>
                                    <option <?php echo $fila["tipo_presentacion"] === 'Granulado' ? "selected='selected'" : "" ?>value="Granulado">Granulado</option>
                                    <option <?php echo $fila["tipo_presentacion"] === 'Polvo' ? "selected='selected'" : "" ?>value="Polvo">Polvo</option>
                              ...
                              <div class="row mb-2">
                                <label class="col-sm-3 col-form-label" style="color:#21618C;">Cantidad de unidades</label>
                                <div class="col-sm-9">
                                 <input min="2020-01-01" type="text" class="form-control" name="cantidad_adquirida"
                                 value='<?php echo $fila["cantidad_adquirida"];?>' readonly>
                                 <small class="text-muted">Este campo no se puede editar</small>
                               </div>
                             </div>
                            ...
                            <div class="row mb-2">
                              ...
                              vencimiento</label>
                              <div class="col-sm-9">
                                <input id="fechavencimiento_act" type="date" class="form-control" name="Fecha_vencimiento"
                                value='<?php echo $fila["Fecha_vencimiento"]; ?>'>
                              </div>
                            </div>
<script>
            ...
            if (fechaCosecha && fechaSiembra > fechaCosecha) {
                ...
                fechaSiembraInput.focus();     // Focalizar nuevamente en el campo de fecha de siembra
                            ...
                            <div class="row mb-2">
                              <label class="col-sm-3 col-form-label" style="color:#21618C;">composición </label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="composicion"  required placeholder=" " oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')"  
                                value='<?php echo $fila["composicion"]; ?>'>
                              </div>
                            </div>
                            ...
                            <div class="row mb-2">
                              <label class="col-sm-3 col-form-label" style="color:#21618C;">Unidad de medida
                              </label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="unidad_medida"  required placeholder="" 
                                value='<?php echo $fila["unidad_medida"]; ?>'>
                              </div>
                            </div>
...
<script>
  function vaciarCampos() {
    document.getElementsByName("nombre_funguisida")[0].value = "";
    document.getElementsByName("tipo_funguisida")[0].value = "";
    document.getElementsByName("tipo_presentacion")[0].value = "";
    document.getElementsByName("marca")[0].value = "";
    document.getElementsByName("composicion")[0].value = "";
