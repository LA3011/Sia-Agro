...
<head>
    <style>
        ...
        .row {
            display: flex;
            justify-content: center; /* Cambio en la alineación para centrar los cuadros */
...
<body>
   <div class="container">
    <h1 style="text-align: center;">Datos Financieros</h1>
     <div class="row">
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="card custom-card">
                    <div class="card-body">
                        <h5 class="card-title">Finanza General</h5>
                        <p class="card-text">Cantidad</p>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card custom-card">
                    <div class="card-body">
                        <h5 class="card-title">Costo Fijo</h5>
                        <p class="card-text">Cantidad</p>
            ...
            <div class="col-lg-4">
                <div class="card custom-card">
                    <div class="card-body">
                        <h5 class="card-title">Costo Variable</h5>
                        <p class="card-text">Cantidad</p>
                        <p class="card-text"><a href="#" class="btn btn-primary">Detalles</a></p>
                    </div>
                </div>
